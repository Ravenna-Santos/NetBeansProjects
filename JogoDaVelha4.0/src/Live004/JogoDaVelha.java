...
public class JogoDaVelha extends JPanel implements MouseListener {
	...
	private Font minhaFontGrand = new Font("Consolas", Font.BOLD, 80);
	private Font minhaFontMedia = new Font("Consolas", Font.BOLD, 30);
	private Font minhaFontPeq = new Font("Consolas", Font.BOLD, 15);
